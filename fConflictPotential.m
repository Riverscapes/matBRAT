...
elseif iPC_UDotX > CrossingLow && iPC_UDotX <= CrossingHigh
    UDotX_Prob = -0.0011867*iPC_UDotX + 0.90118667; % Assign high probability when crossing in reach
elseif iPC_UDotX > CrossingHigh
    UDotX_Prob = 0.01; % Assign high probability when crossing in reach
else
...
elseif iPC_RoadX > 100 && iPC_RoadX <= CrossingHigh
    RoadX_Prob = -0.0011867*iPC_RoadX + 0.90118667; % Assign high probability when crossing in reach
elseif iPC_RoadX > CrossingHigh
    RoadX_Prob = 0.01; % Assign high probability when crossing in reach
else
